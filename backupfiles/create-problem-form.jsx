                  ...
                  <Card key={field.id} className="bg-background">
                    ...
                    <CardFooter>
                      <div className="flex items-center gap-2 mt-4">
                        <input
                          type="checkbox"
                          id={`hidden-test-case-${index}`}
                          {...register(`testCases.${index}.isHidden`)}
                          className="h-4 w-4"
                        />

                        <Label htmlFor={`hidden-test-case-${index}`}>
                          Hidden Test Case
                        </Label>
                      </div>

                      <p className="text-sm text-muted-foreground mt-1">
                        Hidden test cases are used only during submission.
                      </p>
                    </CardFooter>
                  </Card>
                ))}
            ...
            <Card className="border-border/60 bg-gradient-to-br from-card to-muted/20 shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl font-semibold tracking-tight">Test Cases</CardTitle>
                    <p className="text-sm text-muted-foreground">Configure input, expected output, and visibility settings.</p>
                  </div>
                </div>
                <Button
                  type="button"
              ...
              <CardContent className="space-y-4">
                {testCaseFields.map((field, index) => (
                  <Card
                    key={field.id}
                    className="group relative overflow-hidden border-border/80 bg-card/60 transition-all duration-200 hover:border-border hover:shadow-md"
                  >
                    <CardHeader className="flex flex-row items-center justify-between border-b border-border/40 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <CardTitle className="text-base font-medium">Test Case #{index + 1}</CardTitle>
                      </div>
                      <Button
                        type="button"
                        variant="ghost"
                        ...
                        onClick={() => removeTestCase(index)}
                        disabled={testCaseFields.length === 1}
                        className="h-8 text-muted-foreground hover:bg-destructive/10 hover:text-destructive gap-1.5 transition-colors"
                      >
                    ...
                    <CardContent className="grid grid-cols-1 gap-6 pt-6 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          {...register(`testCases.${index}.input`)}
                          placeholder="Enter test case input..."
                          className="min-h-[120px] resize-y font-mono text-sm bg-background/50 focus-visible:bg-background transition-colors"
                        />
                        {errors.testCases?.[index]?.input && (
                    ...
                    <CardFooter className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-t border-border/40 bg-muted/20 px-6 py-3.5 gap-4">
                      <div className="flex items-center gap-3">
                        <input
                          type="checkbox"
                          id={`hidden-test-case-${index}`}
                        ...
                        <div className="space-y-0.5">
                          <Label
                            htmlFor={`hidden-test-case-${index}`}
                            className="text-sm font-medium cursor-pointer"
                          >
                            Hidden Test Case
                          </Label>
                          <p className="text-xs text-muted-foreground">
                            Hidden from candidates and used only during evaluation.
                          </p>
                        </div>
                      </div>
                    </CardFooter>
